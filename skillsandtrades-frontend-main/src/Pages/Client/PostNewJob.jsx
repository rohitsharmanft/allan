...
const PostNewJob = () => {
  ...
  const onFinish = async (values) => {
    ...
    formData.append(
      "closingDate",
      values.closingDate?.format("YYYY-MM-DD") || "",
    );
        ...
        <div className="post-job-wrap">
          <div className="breadcrumb">
            <Breadcrumb
              ...
              items={[
                { title: <Link to="/client-Job">Jobs</Link> },
                {
                  title: (
                    <strong>
                      Post New {type === "project" ? "Project" : "Job"}
                    </strong>
                  ),
                },
              ]}
            ...
            >
              ...
              <Form.Item
                ...
                rules={[
                  {
                    required: true,
                    message: `Please enter a ${type === "project" ? "project" : "job"} title`,
                  },
                  {
                    min: 10,
              ...
              >
                <Input
                  placeholder={`Enter a clear ${type === "project" ? "project" : "job"} title`}
                  maxLength={150}
                  showCount
                />
              </Form.Item>
              ...
              <Form.Item
                label={
                  type === "project" ? "Project Description" : "Job Description"
                }
                name="desc"
                rules={[
                  {
                    required: true,
                    message: `Please write a ${type === "project" ? "project" : "job"} description`,
                  },
                  {
                    min: 50,
              ...
              <Form.Item
                ...
                rules={[
                  {
                    required: true,
                    message: "Please select application closing date",
                  },
                ]}
              >
                <DatePicker
